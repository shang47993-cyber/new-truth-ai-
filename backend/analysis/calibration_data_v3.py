"""calibration_data_v3.py — Comprehensive calibration dataset V3."""

CALIBRATION_SAMPLES = [
    # Human casual / personal
    {
    ...
    # Human classic literature & essays (Orwell, Hemingway, Woolf, Swift)
    {
    ...
    # Human literary & creative writing
    {
    ...
    # AI Formal / Expository (ChatGPT, Claude, Gemini patterns)
    {
    ...
    # AI Literary / Fiction / Dialogue styles
    {
